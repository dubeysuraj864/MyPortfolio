      ...
      <div className="home relative md:h-[auto]  flex justify-center items-center -pt-10 md:py-5 overflow-hidden">
        <div className="container mr-auto ml-auto p-0 w-full h-full flex flex-col items-center justify-center md:flex md:flex-row-reverse md:justify-start md:items-center md:w-full md:py-10 ">
          ...
          <div className=" bg-gray-100 mb-20 md:mb-0">
            ...
            <div className="design3 w-32 absolute right-44 top-80 h-32 bg-red-400 rounded-full shadow-lg"></div>
          ...
          <div className="left w-full px-0 text-left md:text-left h-96 md:p-0 md:w-4/5 md:h-3/4 z-10 md:flex md:justify-end md:ml-0">
            <div className="w-full mt-5 md:mt-0 text-center px-5 h-96 m-auto flex flex-col justify-end md:justify-center md:items-start items-left md:mx-0 py-5">
              <div className=" md:text-left text-3xl tracking-wider md:leading-tight md:text-5xl font-bold  py-2 ">
              ...
              <button className=" my-4 shadow-sm bg-gray-800 w-40 hover:border-gray-800 md:w-40 border-transparent transition-all border-2 hover:text-black hover:bg-white text-white rounded-full px-5 py-2 mb-10 mx-auto md:mx-0">
                {" "}
                <a
                  target="_blank"
