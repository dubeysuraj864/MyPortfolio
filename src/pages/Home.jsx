...
function Home() {
  return (
    <>
      <div className="home relative bg-green-100 flex justify-center pt-10 md:py-0 ">
        <img
          src={Eclipse2}
        ...
        <img
          ...
          alt=""
        />
        <div className="container  mr-auto ml-auto p-0 w-full relative h-full flex flex-col items-center justify-center md:flex md:flex-row-reverse md:justify-center md:items-center md:w-full md:py-10 ">
          <div className="right mr-auto ml-auto  flex justify-center items-center w-full h-96 md:w-2/3 ">
