      ...
      <div className="home relative md:h-[auto]  flex justify-center items-center -pt-10 md:py-5 overflow-hidden">
        <div className="container mr-auto ml-auto p-0 w-full h-full flex flex-col items-center justify-center md:flex md:flex-row-reverse md:justify-start md:items-center md:w-full md:py-10 ">
          <div className=" bg-gray-100 mb-20 md:mb-0">
            <div className="design w-64 absolute -right-10 top-10 h-32 bg-yellow-400 rounded-l-full shadow-sm"></div>
            <div className="design2 w-96 absolute -right-10 top-44 h-32 mr-5 md:mt-1 bg-green-400 rounded-l-full shadow-sm"></div>
            ...
            <div className="design3 w-48 absolute right-80 top-80 h-32 bg-purple-400 rounded-full shadow-lg"></div>
            <div className="design3 w-32 absolute right-44 top-80 h-32 bg-pink-400 rounded-full shadow-lg"></div>
            <div className="design w-32 absolute right-24 top-10 h-32 bg-yellow-200  rounded-full shadow-lg"></div>
            <div className="design3 w-32 absolute right-96 top-80 h-32 bg-purple-300 rounded-full shadow-sm"></div>
            <img
              src={outlineMe3}
