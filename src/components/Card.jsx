...
function Card(props) {
  return (
    <div className="p-4">
      <div className="card w-full md:w-4/6 ml-auto mr-auto  border-gray-200 border-2 flex-col justify-center-center rounded-3xl my-3 py-5 md:flex md:justify-center md:flex-row md:items-center">
