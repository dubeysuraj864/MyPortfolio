...
function Footer() {
  return (
    <>
      <div className="footer flex flex-col justify-center pt-20 bg-green-100 px-2 rounded-t-2xl">
        ...
        <div className=" flex flex-col md:flex md:flex-row md:justify-around pb-8 w-full justify-center items-center">
