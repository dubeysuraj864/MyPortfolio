...
function Footer() {
  return (
    <>
      <div className="flex-col justify-center mt-20 bg-gradient-to-b from-white  to-green-100 ">
        <div className="flex-col justify-between items-center bg-green-500 p-10 rounded-2xl w-fit ml-auto mr-auto mb-16 text-white">
          <div className="left mr-10 ">
            <div className="text-2xl my-2">Have any project in mind?</div>
